...
# this file contains additional procs for use in TeePee enhanced Verilog source files.
...
# possible project name: FISTcl (FInite State Tcl) pronounced "fist tickle" as one word, emphasis on first syllable.
